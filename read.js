...
(function read() {
	...
	var css = '@namespace svg "http://www.w3.org/2000/svg";
		* {
		...
		contentSelectors = ['#article', 'article, .article, .articleContent', '.post-body', '[id^="post"]:not(#postcomment)', '#entry', '.entry, .post, .blogpost', '#content', '.content', '[id^="content"], [class^="content"]', '#main', '.main', 'h1', 'h2', 'big'],
