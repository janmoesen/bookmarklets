/**
 * Look up the specified or selected text in the Vietnamese Wikipedia.
 *
 * @title Vietnamese Wikipedia
 */
(function viw() {
	...
	*/
	...
	if (s === '') {
		s = getActiveSelection() || prompt('Please enter the subject to look up in the Vietnamese Wikipedia:');
	} else {
	...
	if (s) {
		...
		location = 'https://vi.wikipedia.org/w/index.php?searchToken=.&title=Special%3ASearch&ns0=1&search=' + encodeURIComponent(s);
	}
})();
