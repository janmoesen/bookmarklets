/**
 * Look up the specified or selected text in the Norwegian Wikipedia.
 *
...
(function now() {
	...
	*/
	...
	if (s === '') {
		s = getActiveSelection() || prompt('Please enter the subject to look up in the Norwegian Wikipedia:');
	} else {
	...
	if (s) {
		...
		location = 'https://no.wikipedia.org/w/index.php?searchToken=.&title=Special%3ASearch&ns0=1&search=' + encodeURIComponent(s);
	}
})();
