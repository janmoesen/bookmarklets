...
(function ruw() {
	...
	*/
	...
	if (s === '') {
		s = getActiveSelection() || prompt('Please enter the subject to look up in the Russian Wikipedia:');
	} else {
	...
	if (s) {
		...
		location = 'https://ru.wikipedia.org/w/index.php?searchToken=.&title=Special%3ASearch&ns0=1&search=' + encodeURIComponent(s);
	}
})();
