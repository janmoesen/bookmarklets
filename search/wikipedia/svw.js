/**
 * Look up the specified or selected text in the Swedish Wikipedia.
 *
 * @title Swedish Wikipedia
 */
(function svw() {
	...
	*/
	...
	if (s === '') {
		s = getActiveSelection() || prompt('Please enter the subject to look up in the Swedish Wikipedia:');
	} else {
	...
	if (s) {
		...
		location = 'https://sv.wikipedia.org/w/index.php?searchToken=.&title=Special%3ASearch&ns0=1&search=' + encodeURIComponent(s);
	}
})();
