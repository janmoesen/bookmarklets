...
(function dew() {
	...
	*/
	...
	if (s === '') {
		s = getActiveSelection() || prompt('Please enter the subject to look up in the German Wikipedia:');
	} else {
	...
	if (s) {
		...
		location = 'https://de.wikipedia.org/w/index.php?searchToken=&title=Special%3ASearch&search=' + encodeURIComponent(s);
	}
})();
