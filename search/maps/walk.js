...
(function walk() {
	...
	*/
	...
	if (s === '') {
		s = getActiveSelection() || prompt('Please enter your Google Maps walking directions query (e.g. "from Oslo to Santiago de Compostela"):');
	} else {
	...
	if (s) {
		...
		if (locations.length === 1) {
			...
			/* If there are several locations, show the directions. See
			   ...
			   Basically: 3e2 = walking, 4e0 = show in km.
			*/
			url += 'dir/data=!4m3!4m2!3e2!4e0/';
