...
(function bmap() {
	...
	*/
	...
	if (s === '') {
		s = getActiveSelection() || prompt('Please enter your Bing Maps search:');
	} else {
	...
	if (s) {
		...
		if (rewrittenCoordinates.size) {
			/* Note that currently (2023-06-01) Bing Maps does not support directions
			 * between coordinates in this way. It does support directions from a
			 * coordinate pair to a city name, for instance. */
