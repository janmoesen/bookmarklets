		...
		if (!s) {
			...
			if (possibleWikimediaDomainMatches) {
				...
				if (wikimediaDomains.indexOf(possibleWikimediaDomain) > -1 && !document.querySelector('.interlanguage-link')) {
					...
					/* ↓ NOTE ↓: `nl` gets replaced when generating `2nl`, `2fr`, `2it`, …
					...
					console.log(`Translate to Dutch: Wikimedia special case: going to the corresponding page on the Dutch domain ${targetLanguageDomain}: ${urlForOtherLanguage}`);
